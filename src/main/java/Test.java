...
public class Test {
    public static void main(String[] args) {
        Osu osu = new OsuBuilder()
                        .setKey("40c7ffe907acbcdfa992dd129031ad8886662880")
                        .build();
...
//                .runAsync(bestPerformances -> {
//                    bestPerformances.forEach(System.out::println);
//                });
//    }
//
